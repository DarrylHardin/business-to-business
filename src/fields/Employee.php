 ...
 *
 * Allow businesses to create employees for employees that allows the purchasing of products to be charged to the company at a later date.
 *
...
use importantcoding\businesstobusiness\assetbundles\employeefield\EmployeeFieldAsset;
...
class Employee extends Field
{
    ...
    {
        return Craft::t('business-to-business', 'Employees');
    }
    ...
    {
        return Craft::t('business-to-business', 'Add an Employee');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'business-to-business/_components/fields/Employee_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(EmployeeFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').BusinessToBusinessEmployee(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'business-to-business/_components/fields/Employee_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
