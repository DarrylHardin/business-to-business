...
use importantcoding\businesstobusiness\assetbundles\voucherfield\VoucherFieldAsset;
...
class Voucher extends Field
{
    ...
    {
        return Craft::t('business-to-business', 'Voucher');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'business-to-business/_components/fields/Voucher_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(VoucherFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').BusinessToBusinessVoucher(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'business-to-business/_components/fields/Voucher_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
