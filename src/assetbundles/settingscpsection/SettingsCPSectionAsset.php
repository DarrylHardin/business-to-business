...
namespace importantcoding\businesstobusiness\assetbundles\settingscpsection;
...
class SettingsCPSectionAsset extends AssetBundle
{
    ...
    public function init()
    {
        ...
        $this->sourcePath = "@importantcoding/businesstobusiness/assetbundles/settingscpsection/dist";
