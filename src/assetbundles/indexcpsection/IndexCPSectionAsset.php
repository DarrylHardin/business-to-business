...
namespace importantcoding\businesstobusiness\assetbundles\indexcpsection;
...
class IndexCPSectionAsset extends AssetBundle
{
    ...
    public function init()
    {
        ...
        $this->sourcePath = "@importantcoding/businesstobusiness/assetbundles/indexcpsection/dist";
